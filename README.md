# Jobser
Flutter application to view and add vacancies and employer companies. With the implementation of Clean Architecture, REST API for communicate with remote server(was used DIO package) and local DB(Hive) for saving and caching result. Clean architecture with presentation, domain, data and remote layers.Was used Injector for getting instances.
